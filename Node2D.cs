...
public class Node2D : Godot.Node2D {
	...
	/** PROPERTIES *********************************************************************/
	private Property<int> pTime = PropertyPool.RegisterNewProperty("main.level.time", 0, "$main.playerinfo");
	private Property<string> pLevelName = PropertyPool.RegisterNewProperty("main.level.name", "", "$main.playerinfo");
	/** PROPERTIES *********************************************************************/
	private float time;

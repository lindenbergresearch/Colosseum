...
public static class NativeStateExtension {
	...
	public static void SetupNativeStates(this object obj) {
		...
		/* tricky */
		foreach (var fieldInfo in t.GetFields(BindingFlags.NonPublic | BindingFlags.Instance)) //Console.WriteLine($"Field: {fieldInfo.Name} {fieldInfo.FieldType}");
